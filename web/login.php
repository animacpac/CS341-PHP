...
<?php include 'session_check_index.php' ?>
<?php include 'controllers/base/head.php' ?>
<div class="container">
    <div class="row">
      <div class="main">
          <h3 style="color:#65aeee;">Please Log In or <a href="signUp.php">Sign Up</a></h3>
          <!-- <div class="row">
          ...
          <form role="form" action="login-process.php" method="post" name="login">
